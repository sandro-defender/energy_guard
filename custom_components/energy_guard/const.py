...
#: Canonical repository.  Every user-facing link (device page, Repairs issues,
#: manifest) is derived from this one constant so they can never drift apart.
REPOSITORY_URL: Final = "https://github.com/sandro-defender/energy_guard"
